...
class _EditScreenState extends State<EditScreen> {
  ...
  Future<void> _selectMemo(int userId) async {
    var memoList = await DB.selectMemoDetail(userId);
    if (memoList.isNotEmpty) {
      var item = memoList.first;
      setState(() {
  ...
  Future<void> _updateMemo(int id, String title, String content) async {
