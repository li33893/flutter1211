...
// 새롭게 추가될 경우
  ...
  static Future<List<Map<String, dynamic>>> selectUserDetail(int userId) async {
    final db = await getDatabase();
    return await db.query('TBL_USER', where: 'userId = ?', whereArgs: [userId]); // 'Test' 테이블의 모든 데이터를 조회
  }
